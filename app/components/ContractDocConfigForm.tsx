  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        <label className="text-sm font-medium text-[var(--color-text)]" htmlFor="doc-template-name">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--color-text)]" htmlFor="doc-template-id">
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--color-text)]" htmlFor="doc-template-version">
            Versão
          </label>
          <input
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[var(--color-text)]" htmlFor="doc-template-platform">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <label className="flex items-center gap-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text)]">
          <input
            type="checkbox"
        ...
        <label className="flex items-center gap-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text)] md:col-span-2">
          <input
            type="checkbox"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--color-text)]" htmlFor="doc-template-last-updated">
            Última atualização
          </label>
          <input
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[var(--color-text)]" htmlFor="doc-template-attachments">
        ...
        <textarea
          ...
          className="min-h-[120px] w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-sm text-[var(--color-text)] focus:border-[var(--color-primary)] focus:outline-none"
