    ...
    <div className="space-y-4">
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-1">
          <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-start-date">
            Início da vigência
          </label>
          <input
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-end-date">
            Fim da vigência
          </label>
          <input
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-renewal">
          Renovação
        </label>
        <select
          id="contract-renewal"
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-responsibilities">
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-guarantees">
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-clauses">
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-[color:var(--color-text)]" htmlFor="contract-notice-period">
