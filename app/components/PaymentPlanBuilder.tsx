    ...
    <div className="space-y-5">
      <div className="grid gap-4 md:grid-cols-3">
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--color-text)]">Valor total</label>
          <input
            type="number"
            min={0}
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--color-text)]">Entrada (%)</label>
          <input
            type="number"
            min={0}
            max={100}
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--color-text)]">Juros (% a.m.)</label>
          <input
            type="number"
            min={0}
            step="0.1"
      ...
      <div className="space-y-3">
        <p className="text-sm font-semibold text-[var(--color-text)]">Formas de pagamento aceitas</p>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-[var(--color-text)]">Parcelas</h3>
          <button
            type="button"
        ...
        {value.installments.length === 0 ? (
          <p className="text-xs text-[var(--color-text-muted)]">Nenhuma parcela configurada.</p>
        ) : (
            ...
            {value.installments.map((installment, index) => (
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <h4 className="text-sm font-semibold text-[var(--color-text)]">Parcela #{installment.sequence}</h4>
                  <button
                    type="button"
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-2">
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-[var(--color-text-muted)]">Número</label>
                    <input
                      type="number"
                      min={1}
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-[var(--color-text-muted)]">Vencimento</label>
                    <input
                      type="date"
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-[var(--color-text-muted)]">Valor</label>
                    <input
                      type="number"
                      min={0}
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-[var(--color-text-muted)]">Forma</label>
                    <select
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-[var(--color-text)]">Política de inadimplência</label>
        <textarea
