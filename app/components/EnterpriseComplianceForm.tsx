  ...
  return (
    <div className="space-y-6">
      <section className="space-y-3">
        <h3 className="text-sm font-semibold text-[var(--color-text)]">Características operacionais</h3>
      ...
      <section className="space-y-3">
        <h3 className="text-sm font-semibold text-[var(--color-text)]">Perfil ambiental</h3>
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1">
            <label htmlFor="enterprise-env-classification" className="text-sm font-medium text-[var(--color-text)]">
          ...
          <div className="space-y-1">
            <label htmlFor="enterprise-env-waterUsage" className="text-sm font-medium text-[var(--color-text)]">
              Uso de água
            </label>
            <input
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1">
            <label htmlFor="enterprise-env-energyMatrix" className="text-sm font-medium text-[var(--color-text)]">
              Matriz energética
            </label>
            <input
          ...
          <div className="space-y-1">
            <label htmlFor="enterprise-env-wastePlan" className="text-sm font-medium text-[var(--color-text)]">
              Plano de resíduos
            </label>
            <input
        ...
        <div className="space-y-1">
          <label htmlFor="enterprise-env-notes" className="text-sm font-medium text-[var(--color-text)]">
            Observações
          </label>
          <textarea
      ...
      <section className="space-y-3">
        <h3 className="text-sm font-semibold text-[var(--color-text)]">Flags de compliance</h3>
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="flex items-start gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text)]">
            <input
              type="checkbox"
            ...
            />
            <span>
              <strong className="block text-[var(--color-text)]">Ambiental</strong>
              <span className="text-xs text-[var(--color-text-muted)]">Relatórios ambientais atualizados e protocolados.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text)]">
            <input
            ...
            />
            <span>
              <strong className="block text-[var(--color-text)]">Social</strong>
              <span className="text-xs text-[var(--color-text-muted)]">Planos de relacionamento comunitário aprovados.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text)]">
            <input
            ...
            />
            <span>
              <strong className="block text-[var(--color-text)]">Segurança</strong>
              <span className="text-xs text-[var(--color-text-muted)]">Treinamentos e brigadas conformes com normas internas.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3 text-sm text-[var(--color-text)]">
            <input
            ...
            />
            <span>
              <strong className="block text-[var(--color-text)]">Notificações</strong>
              <span className="text-xs text-[var(--color-text-muted)]">Sinalize se há notificações ou auditorias pendentes.</span>
            </span>
          </label>
        </div>
        <div className="space-y-1">
          <label htmlFor="enterprise-flags-notes" className="text-sm font-medium text-[var(--color-text)]">
